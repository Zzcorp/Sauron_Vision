...
urlpatterns = [
    ...
    path("api/nav-activity/", views.nav_activity_json, name="nav_activity_json"),
    # The investor window — the ONLY routes the investor gate admits.
    path("investor/", __import__("dashboard.views_investor",
         fromlist=["investor_panel"]).investor_panel, name="investor_panel"),
    ...
    path("admin-dashboard/investors/create/",
         ...
         name="hq_create_investor"),
    path("admin-dashboard/investors/toggle/",
         __import__("dashboard.views_investor",
         fromlist=["hq_toggle_investor"]).hq_toggle_investor,
         name="hq_toggle_investor"),
